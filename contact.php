...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .contact-section { background: var(--light-bg); padding: 70px 0 60px; }
        .contact-info { text-align: center; padding: 30px 20px; background: #ffffff; border: 1px solid var(--qc-card-border); border-radius: 12px; transition: transform 0.2s ease, box-shadow 0.2s ease; height: 100%; }
        .contact-info:hover { transform: translateY(-4px); box-shadow: 0 10px 24px rgba(17, 82, 114, 0.1); }
        .contact-icon {
            width: 72px;
            height: 72px;
            margin: 0 auto 16px;
        ...
        .contact-info h4 { font-weight: 700; color: var(--qc-primary-900); margin-bottom: 12px; }
        .contact-info p { color: var(--qc-shades-500); margin-bottom: 0; }

...
<head>
    ...
    <style>
        ...
        * {
        ...
        .a11y-fab-btn:hover {
            transform: scale(1.1);
            box-shadow: 0 6px 28px rgba(30, 60, 114, 0.55);
        }
        ...
        body.high-contrast .section.bg-light {
            background: #111 !important;
        }
        ...
        body.high-contrast .report-form {
        ...
        body.high-contrast p, body.high-contrast .card-text,
        body.high-contrast .stat-label, body.high-contrast .text-muted {
            color: #ccc !important;
        }
        ...
        body.high-contrast .a11y-panel h5 {
            color: #fff;
        }
        ...
        body.high-contrast .a11y-btn-group button {
            background: #333;
            color: #fff;
            border-color: #555;
        }

        body.high-contrast .a11y-btn-group button:hover {
            background: #fff;
            color: #000;
        }
        ...
        body.high-contrast .a11y-reset {
            background: #333;
            color: #fff;
        }

        body.high-contrast .a11y-reset:hover {
            background: #555;
        }
        ...
        /* Large Text Mode */
        body.large-text p, body.large-text .card-text,
        body.large-text .stat-label, body.large-text .lead {
            font-size: 1.15em;
        }
...
<body>
    ...
    <script>
        ...
        let highContrast = localStorage.getItem('a11y_highContrast') === 'true';
        ...
        // Large Text Toggle
        let largeText = localStorage.getItem('a11y_largeText') === 'true';
        ...
        let readableFont = localStorage.getItem('a11y_readableFont') === 'true';
        ...
        (function restoreA11y() {
            ...
            if (largeText) {
                ...
                document.getElementById('largeTextToggle').classList.add('active');
            }
            if (readableFont) {
    ...
    <div class="a11y-fab" id="a11yFab">
        <div class="a11y-panel" id="a11yPanel">
            ...
            <button class="a11y-reset" onclick="resetAccessibility()">

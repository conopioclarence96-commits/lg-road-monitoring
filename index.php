...
<body>
    ...
    <script>
        ...
        function initCitizenMap() {
            const latlngs = QC_COORDS.map(c => [c[1], c[0]]);
            qcPolygon = L.polygon(latlngs, {
                color: '#2a5298',
                weight: 2,
                fill: true,
                fillColor: '#2a5298',
        ...
        function isInsideQC(lat, lng) {
            ...
            return poly.getBounds().contains([lat, lng]);
        }

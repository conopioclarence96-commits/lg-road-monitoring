...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $basePath; ?>styles/style.css?v=2" />
    <link rel="stylesheet" href="<?php echo $basePath; ?>styles/login.css?v=3" />
    <link rel="stylesheet" href="<?php echo $basePath; ?>styles/transition.css?v=2" />

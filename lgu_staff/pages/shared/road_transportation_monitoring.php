    ...
    switch ($_POST['action']) {
        case 'submit_report':
            ...
            try {
                ...
                $qc_polygon = [
                    [14.6078, 120.9796], [14.6120, 120.9812], [14.6170, 120.9825],
                    [14.6225, 120.9838], [14.6285, 120.9850], [14.6345, 120.9862],
                    [14.6405, 120.9875], [14.6465, 120.9890], [14.6525, 120.9908],
                    [14.6585, 120.9928], [14.6645, 120.9950], [14.6705, 120.9975],
                    [14.6765, 121.0000], [14.6825, 121.0025], [14.6885, 121.0052],
                    [14.6945, 121.0080], [14.7000, 121.0110], [14.7055, 121.0142],
                    [14.7105, 121.0176], [14.7150, 121.0212], [14.7192, 121.0250],
                    [14.7235, 121.0290], [14.7275, 121.0335], [14.7315, 121.0380],
                    [14.7355, 121.0428], [14.7390, 121.0480], [14.7425, 121.0535],
                    [14.7458, 121.0590], [14.7488, 121.0648], [14.7515, 121.0705],
                    [14.7540, 121.0765], [14.7562, 121.0825], [14.7580, 121.0885],
                    [14.7595, 121.0940], [14.7605, 121.0995], [14.7608, 121.1045],
                    [14.7602, 121.1095], [14.7588, 121.1145], [14.7565, 121.1195],
                    [14.7535, 121.1240], [14.7498, 121.1285], [14.7455, 121.1325],
                    [14.7405, 121.1360], [14.7350, 121.1392], [14.7290, 121.1420],
                    [14.7230, 121.1442], [14.7165, 121.1460], [14.7100, 121.1472],
                    [14.7030, 121.1480], [14.6960, 121.1482], [14.6890, 121.1475],
                    [14.6820, 121.1458], [14.6755, 121.1428], [14.6695, 121.1385],
                    [14.6640, 121.1330], [14.6590, 121.1265], [14.6545, 121.1195],
                    [14.6505, 121.1120], [14.6470, 121.1045], [14.6440, 121.0968],
                    [14.6415, 121.0890], [14.6390, 121.0812], [14.6365, 121.0735],
                    [14.6340, 121.0658], [14.6315, 121.0582], [14.6290, 121.0508],
                    [14.6265, 121.0435], [14.6238, 121.0362], [14.6210, 121.0290],
                    [14.6180, 121.0218], [14.6152, 121.0148], [14.6125, 121.0078],
                    [14.6102, 121.0008], [14.6085, 120.9940], [14.6072, 120.9872],
                    [14.6078, 120.9796]
                ];
                $inside_qc = false;
                $n = count($qc_polygon);
...
<body class="<?php echo !empty($_SESSION['darkmode']) ? 'dark-mode' : ''; ?>">
    ...
    <script>
        ...
        // Define Quezon City administrative boundary
        ...
        map.fitBounds(QC_POLYGON.getBounds());

...
// Classification shared by the archive source dropdown. A report is labelled
// by its originating system using the same columns the rest of the system
// relies on (report_type, report_source, created_by):
//   - infrastructure : infrastructure_issue / maintenance reports
//   - cimm           : externally-sourced reports (report_source = external)
//   - lgu            : LGU Monitoring reports submitted by staff (created_by != 0)
//   - citizen        : public/citizen-submitted reports (created_by = 0)
$source_case = "CASE
...
// Build searchable per-source WHERE condition
...
// Total filtered count (used for the badge and pagination)
...
<body class="<?php echo !empty($_SESSION['darkmode']) ? 'dark-mode' : ''; ?>">
        ...
        <div class="filters-section" style="margin-bottom:24px;">
            <div class="filter-group">
                ...
                <div>
                    ...
                    <select class="filter-select" id="sourceFilter" onchange="filterReports(1)">
                        ...
                        <div class="archive-content">
                            ...
                            <div class="archive-meta">
                                ...
                                <span class="meta-item"><i class="fas fa-sitemap"></i>
                                    <span class="source-badge <?php echo $row['source_system'] === 'citizen' ? 'source-citizen' : 'source-' . $row['source_system']; ?>"><?php echo htmlspecialchars($row['source_system']); ?></span>
                                </span>
                            </div>
    ...
    <script>
        ...
        function viewArchive(id) {
            ...
            var sourceSys = row.source_system || 'citizen';
            var sourceLabel = sourceLabels[sourceSys] || sourceSys || 'Unknown';
            var sourceIcon = sourceIcons[sourceSys] || 'fa-file-archive';

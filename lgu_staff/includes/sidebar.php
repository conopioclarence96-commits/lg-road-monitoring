...
function getNavigationItems($user_role) {
    $base_items = [
        'main' => [
            ...
            [
                'href' => '../pages/main/pending_approvals.php',
                'icon' => 'person-check',
            ...
            if ($total_items === 0) {
                ...
                <div class="nav-section">
                    ...
                    <ul style="list-style: none;">
                        ...
                        <li><a href="../pages/main/pending_approvals.php" class="nav-link" target="_parent">👤 Pending Approvals</a></li>
                                    ...
                                    <a href="<?php echo $item['href']; ?>" class="nav-link" target="_parent">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-<?php echo $item['icon']; ?>" viewBox="0 0 16 16">
                                            ...
                                            $icon_paths = [
                                                ...
                                                'person-check' => '<path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-2 3a2 2 0 0 0-2 2v1a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2v-1a2 2 0 0 0-2-2H4zm12.854 2.146a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 0 1 .708-.708L15.5 14.293l2.646-2.647a.5.5 0 0 1 .708 0z"/>',

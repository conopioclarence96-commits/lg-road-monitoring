        ...
        <div class="sidebar-content">
            ...
            <div class="nav-section">
                <ul style="list-style: none;">
                    <li>
                        <a href="../../../index.php" class="nav-link" target="_parent">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M2 13.5V7h1v6.5a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V7h1v6.5a1.5 1.5 0 0 1-1.5 1.5h-9A1.5 1.5 0 0 1 2 13.5zm11-6V3.5a.5.5 0 0 0-.5-.5h-9a.5.5 0 0 0-.5.5V7.5h10z"/>

...
$nav_items = [
    ...
    'monitoring' => [
        ['href' => $nav_base . 'pages/shared/road_transportation_monitoring.php', 'icon' => 'map-marked-alt', 'title' => 'Road Monitoring', 'roles' => ['system_admin','road_ops_supervisor', 'transportation_ops_supervisor', 'road_monitoring_officer', 'trans_monitoring_officer']],

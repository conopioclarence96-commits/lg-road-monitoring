<?php
// handle_report_no_auth.php - Working version without authentication for testing
...
try {
    ...
    $user_id = $anonymous_report ? null : null; // Simplified for testing
    
    // Simple user handling - get any existing user

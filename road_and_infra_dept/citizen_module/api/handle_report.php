...
try {
    ...
    $stmt->bind_param("sissssssssi", $report_id, $user_id, $location, $barangay, $damage_type, $severity, $description, $estimated_size, $traffic_impact, $contact_number, $anonymous_report, $images_json);
